                                ...
                                <div class="clearfix">
                                    <div class="float-left">
                                        <a href="{{route('room',['id'=>encrypt($question['room_id']['id'])])}}">
                                            <button type="button" class="btn btn-sm btn-outline-dark float-left" style="margin-right: 1rem"><i class="fas fa-arrow-left"></i> Trở về
                                            </button>
                                        </a>
                                        <button type="button" class="btn btn-sm btn-outline-dark float-left" style="margin-right: 1rem"><i class="far fa-caret-square-up"></i> Upvote
                                            (123)
                                        </button>
                                    </div>
                                    <!--Cho chu cau hoi-->
                                    <div class="float-left" style="display: flex">
                                        ...
                                        {{-- </div>--}}
                                        <!---->
                                        <button class="btn btn-sm btn-danger" style="margin-right: 1rem">Xóa câu hỏi <i class="fas fa-trash"></i></button>
                                    </div>
                                    <!---->
                                </div>
                                <div class="userBox">
                            ...
                            <div class="comment">
                                ...
                                <div class="commentBody">
                                    <div class="form-group postComment">
                                        <textarea name="comment" form="post-comment" class="form-control" id="commentForm" rows="3" placeholder="Trả lời câu hỏi..."></textarea>
                                        <form method="post" id="post-comment" action="{{route('post-comment')}}">
                                            @csrf
                                            <input type="hidden" name="user_id" value="{{$curUser['id']}}">
                                            <input type="hidden" name="question_id" value="{{$question['id']}}">
                                            <button type="submit" class="btn btn-sm btn-primary">Đăng <i class="far fa-comment"></i></button>
                                        </form>
                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                ...
                                                <div class="commentText">
                                                    ...
                                                    <div class="extraButtons clearfix">
                                                        ...
                                                        <button type="button" class="btn btn-sm btn-success float-right">Chỉnh
                                                            sửa
                                                        </button>
                                                    </div>
                                                </div>
