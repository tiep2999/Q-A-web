                        ...
                        <div class="MainContent">
                            <div class="menu clearfix">
                                <ul class="nav nav-tabs float-left" id="myTab">
                                    ...
                                    <li class="nav-item ">
                                        <a class="nav-link {{(isset($conditions['deleted']))?'active':''}}" href="{{env('APP_URL')}}/uet-forum/dashboard-search?deleted=1">Đã
                                            đóng</a>
                                    </li>
                                </ul>
                            ...
                            <div id="lietkephong">
                                <ul class="list-group">
                                    ...
                                    <li>
                                        <div class="card room">
                                            <h5 class="card-header"><a href="{{route('room',['id'=>encrypt($room['id'])])}}">{{$room['name']}}</a>
                                            </h5>
                                                ...
                                                <div class="col-sm">
                                                    <div class="float-right">
                                                        <ul class="list-group list-group-horizontal justify-content-center">
                                                            ...
                                                            <li class="list-group-item marked"><i class="fas fa-heart"></i></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="card-footer roomfoot clearfix">
                                                ...
                                                <a class="float-right" href="{{route('room',['id'=>encrypt($room['id'])])}}">Chi tiết <i class="fas fa-angle-right"></i></a>
                                            </div>
                                        </div>
                                    </li>
                                    @endforeach
