                                                ...
                                                <div class="modal-content" style="color: black">
                                                    <form action="{{route('update-room')}}" method="post" id="update-room">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label class="col-form-label">Mật khẩu
                                                                            mới:</label>
                                                                        <input type="password" class="form-control" name="password_new" id="matkhau">
                                                                        <small id="matkhau" class="form-text" style="color: #007bff">Để trống nếu
                                                                            không
                                                                            đặt
                                                                            mật
                                                                            khẩu
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label class="col-form-label">Nhập lại mật khẩu
                                                                            mới :</label>
                                                                        <input type="password" class="form-control" name="password_vali" id="matkhau">
                                                                        <small id="matkhau" class="form-text" style="color: #007bff">Để trống nếu
                                                                            không
                                                                            đặt
                                                                            mật
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <label class="col-form-label">Mật khẩu
                                                                            cũ:</label>
                                                                        <input type="password" class="form-control" name="password_old" id="matkhau">
                                                                        <small id="matkhau" class="form-text" style="color: #007bff">Để trống nếu
                                                                            không
                                                                            đặt
                                                                            mật
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="submit" class="btn btn-info" id="edit" name="sua" value="Cập nhật">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <div class="comment">
                                ...
                                <div class="commentBody">
                                    <div class="form-group postComment clearfix">
                                        <textarea name="question" class="form-control" form="post-question" id="commentForm" rows="3" placeholder="Viết câu hỏi..."></textarea>
                                        <a role="button" href="#" class="btn btn-sm btn-outline-dark float-left" style="margin-right: 10px"><i class="fab fa-facebook-square"></i> Chia
                                            sẻ</a>
                                        <a role="button" href="#" class="btn btn-sm btn-outline-dark float-left"><i class="far fa-envelope"></i> Chia sẻ</a>
                                        <form id="post-question" method="post" action="{{route('post-question')}}">
                                            @csrf
                                            <input name="user_id" value="{{$curUser['id']}}" type="hidden">
                                            <input type="hidden" name="room_id" value="{{$room['id']}}">
                                            <button type="submit" class="btn btn-sm btn-primary float-right">Đăng <i class="far fa-comment"></i></button>
                                        </form>
                                    </div>
                                        ...
                                        <div class="commentSearch">
                                            <form class="form-inline">
                                                <div class="input-group searchbox">
                                                    <input type="search" class="form-control form-control-sm sinput" placeholder="Tìm kiếm...">
                                                ...
                                                <div class="commentText">
                                                    <div class="commentWrapper">
                                                        <div class="userName justify-content-between">
                                                            <div>
                                                                <div class="name"><a href="#">{{$que['user_id']['fullName']}}</a>
                                                                </div>
